...
interface IZkSyncInterface extends ethers.utils.Interface {
  functions: {
    ...
    "requestL2Transaction(address,bytes,uint256,bytes[])": FunctionFragment;
...
export class IZkSync extends Contract {
  ...
  functions: {
    ...
    "commitBlocks((uint32,uint16,bytes32,bytes32,uint256,bytes32,bytes32),tuple[])"(
      _lastCommittedBlockData: {
        blockNumber: BigNumberish;
        numberOfLayer1Txs: BigNumberish;
        priorityOperationsHash: BytesLike;
    ...
    "proveL2LogInclusion(uint256,uint256,(address,bytes32,bytes32),bytes32[])"(
      _blockNumber: BigNumberish,
      _index: BigNumberish,
      _log: { sender: string; key: BytesLike; value: BytesLike },
      _proof: BytesLike[],
    ...
    "proveL2MessageInclusion(uint256,uint256,(address,bytes),bytes32[])"(
      _blockNumber: BigNumberish,
      _index: BigNumberish,
      _message: { sender: string; data: BytesLike },
      _proof: BytesLike[],
    ...
    "requestL2Transaction(address,bytes,uint256,bytes[])"(
      _contractAddressL2: string,
      _calldata: BytesLike,
      _ergsLimit: BigNumberish,
      _factoryDeps: BytesLike[],
