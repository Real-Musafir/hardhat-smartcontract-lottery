...
export function AdapterL1<TBase extends Constructor<TxSender>>(Base: TBase) {
    return class Adapter extends Base {
        ...
        async requestExecute(transaction: {
            ...
            const { contractAddress, calldata, ergsLimit, factoryDeps, operatorTip, overrides } = tx;
            overrides.gasPrice ??= await this._providerL1().getGasPrice();
            ...
            return this._providerL2().getPriorityOpResponse(
                await zksyncContract.requestL2Transaction(contractAddress, calldata, ergsLimit, factoryDeps, overrides)
            );
        }
    };
}
